...
describe "BeermappingApi" do
    ...
    describe "incase of possible cache hits" do
        ...
        it "when HTTP GET returns no entries, there should be an empty array" do
            canned_answer = <<-END_OF_STRING 
        ...
        it "when HTTP GET returns many entries, they should all be in an array" do
            canned_answer = <<-END_OF_STRING
